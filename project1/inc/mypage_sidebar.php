...
<aside class="mypage-sidebar">
    <div class="sidebar-header-mobile">
        ...
        <button type="button" class="mypage-menu-toggle" onclick="toggleMypageMenu()">
            메뉴 <i class="fas fa-chevron-down"></i>
        </button>
    </div>
    
    <div class="mypage-menu-list" id="mypageMenuList">
        <h3>나의 쇼핑 정보</h3>
        <ul>
            <li><a href="my-page_order.php" class="<?= $current_page == 'my-page_order.php' ? 'active' : '' ?>">주문배송 조회</a></li>
            <li><a href="my-page_cancel_return.php" class="<?= $current_page == 'my-page_cancel_return.php' ? 'active' : '' ?>">취소/교환/반품 내역</a></li>
        </ul>

        <h3>나의 혜택 관리</h3>
        <ul>
            <li><a href="#" onclick="alert('준비중입니다.'); return false;">쿠폰함</a></li>
            <li><a href="my-page_point.php" class="<?= $current_page == 'my-page_point.php' ? 'active' : '' ?>">포인트</a></li>
        </ul>

        <h3>나의 활동 관리</h3>
        <ul>
            <li><a href="my-page_reviews.php" class="<?= $current_page == 'my-page_reviews.php' ? 'active' : '' ?>">리뷰 관리</a></li>
            <li><a href="customer_center.php?page=inquiry" class="<?= $current_page == 'customer_center.php' ? 'active' : '' ?>">1:1 문의</a></li>
        </ul>
        ...
        <ul>
            ...
            <li><a href="my-page_address.php" class="<?= $current_page == 'my-page_address.php' ? 'active' : '' ?>">배송지 관리</a></li>
        </ul>
    </div>
</aside>
...
function toggleMypageMenu() {
    const list = document.getElementById('mypageMenuList');
    const btn = document.querySelector('.mypage-menu-toggle');
...
<style>
    ...
    @media (max-width: 768px) {
        .mypage-sidebar .sidebar-header-mobile {
            display: flex;
